...
public class BiGramsApp {
    public static void main(String[] args) {
        ...
        //JavaPairRDD<Bigram, Integer> pairedBigrams = bigrams.mapToPair(bigram -> new Tuple2<>(bigram, 1));

        //JavaPairRDD<Bigram, Integer> countedBigrams = pairedBigrams.reduceByKey(Integer::sum);
